...
from cli.commands.user_groups_command import UserGroupsCommand
...
class JPAPIDevCLI:
    ...
    def _register_commands(self):
        ...
        registry.register(UpdateCommand, aliases=["apply"])

        # Register sync command as full-fledged feature
        ...
        registry.register(UserGroupsCommand, aliases=["user-groups", "usergroups"])
        registry.register(
